...
The native app targets `https://chitchatamaan.duckdns.org`. Release builds require trusted HTTPS and do not include a broad App Transport Security cleartext exception.
